...
urlpatterns = patterns(
    ...
    url(r'^(?P<namespace>' + EXTENDED_URL_REGEX + ')/(?P<project>' + EXTENDED_URL_REGEX + ')/',
        include(patterns('',
            ...
            url(r'^describe/$', ProjectsDescribeView.as_view(), name='projects-describe'),
            url(r'^rename/$', ProjectsRenameView.as_view(), name='projects-rename'),
            url(r'^delete/$', ProjectsDeleteView.as_view(), name='projects-delete'),
