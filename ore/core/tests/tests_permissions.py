...
class PermissionsTestCase(TestCase):
    def setUp(self):
        self.permission_foo = Permission.objects.create(slug='foo.do', name='Do Foo', description='Performs foo')
        self.permission_bar = Permission.objects.create(slug='foo.bar', name='Bar', description='Bars foo')
        self.permission_baz = Permission.objects.create(slug='baz.do', name='Do Baz', description='Bazzes the widget')
