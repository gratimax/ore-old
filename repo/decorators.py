...
def permission_required(permission_slug, raise_exception=False):
    ...
    def _permission_required(f):
        ...
        def _permission_required(request, *args, **kwargs):
            ...
            if project:
                obj = get_object_or_404(models.Project, name=project, namespace__name=namespace)
            else:
                obj = get_object_or_404(models.Namespace.objects.select_subclasses(), name=namespace)
